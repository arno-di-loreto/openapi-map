    ...
    dragListener = d3.behavior.drag()
        ...
        .on('drag', function(d) {
            ...
            if (selectedNode) {
                ...
                if (typeof selectedNode.children !== 'undefined' || typeof selectedNode.closedChildren !== 'undefined') {
                    if (typeof selectedNode.children !== 'undefined') {
                        selectedNode.children.push(draggingNode);
                    } else {
                        selectedNode.closedChildren.push(draggingNode);
                    }
                } else {
